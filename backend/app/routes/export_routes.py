...
from app.models.export_models import ExportSelectedRequest
...
def export_selected(request: ExportSelectedRequest) -> Response:
    """按素材 ID 列表导出选中的素材为 zip 包。"""
    try:
        export_response, zip_bytes = export_service.export_selected(request.assetIds)
